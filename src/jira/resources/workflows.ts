...
export class WorkflowsResource {
  ...
  /**
   * Get a workflow by name through the legacy workflow search endpoint.
   * @deprecated Use searchWorkflows({ queryString }) or bulkGet() for new code.
   */
...
export interface WorkflowSearchParams {
  ...
  readonly isActive?: boolean;
  /** Filter to workflows associated with this numeric project ID. */
