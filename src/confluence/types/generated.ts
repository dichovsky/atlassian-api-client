...
export interface paths {
    ...
    "/app/properties": {
         ...
         * @description Gets Forge app properties. This API can only be accessed using **[asApp()](https://developer.atlassian.com/platform/forge/apis-reference/fetch-api-product.requestconfluence/#method-signature)** requests from Forge.
         */
        get: operations["getForgeAppProperties"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/app/properties/{propertyKey}": {
         ...
         * @description Gets a Forge app property by property key. This API can only be accessed using **[asApp()](https://developer.atlassian.com/platform/forge/apis-reference/fetch-api-product.requestconfluence/#method-signature)** requests from Forge.
         */
        get: operations["getForgeAppProperty"];
        /**
         * Create or update a Forge app property.
         * @description Creates or updates a Forge app property. This API can only be accessed using **[asApp()](https://developer.atlassian.com/platform/forge/apis-reference/fetch-api-product.requestconfluence/#method-signature)** requests from Forge.
         */
        put: operations["putForgeAppProperty"];
        post?: never;
        /**
         * Deletes a Forge app property.
         * @description Deletes a Forge app property. This API can only be accessed using **[asApp()](https://developer.atlassian.com/platform/forge/apis-reference/fetch-api-product.requestconfluence/#method-signature)** requests from Forge.
         */
    ...
    "/attachments/{id}/thumbnail/download": {
         ...
         * @description Redirects the client to a URL that serves an attachment thumbnail's binary data.
         *
         *     **[Permissions](https://confluence.atlassian.com/x/_AozKw) required**:
         *     Permission to view the attachment's container.
         */
        get: operations["getAttachmentThumbnailById"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/space-role-mode": {
        ...
        /**
         * Get space role mode
         * @description Retrieves the space role mode.
         *
         *     Available on tenants with [Role-Based Access Control](https://support.atlassian.com/confluence-cloud/docs/manage-user-roles/).
         *
         *     **[Permissions](https://confluence.atlassian.com/x/_AozKw) required**:
         *     Permission to access the Confluence site ('Can use' global permission).
         */
        get: operations["getSpaceRoleMode"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/space-roles": {
         ...
         */
        post: operations["createSpaceRole"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/space-roles/{id}": {
         ...
         *     User must be an organization or site admin. Connect and Forge app users are not authorized to access this resource.
         */
        put: operations["updateSpaceRole"];
        post?: never;
        /**
         * Delete a space role
         ...
         *     User must be an organization or site admin. Connect and Forge app users are not authorized to access this resource.
         */
        delete: operations["deleteSpaceRole"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        DatabaseSingle: {
            ...
            /** @description ID of the space the database is in. */
            spaceId?: string;
            status?: components["schemas"]["ContentStatus"];
        ...
        FolderSingle: {
             ...
             */
            position?: number | null;
            /** @description ID of the space the folder is in. */
            spaceId?: string;
            status?: components["schemas"]["ContentStatus"];
        ...
        SmartLinkSingle: {
             ...
             */
            position?: number | null;
            /** @description ID of the space the Smart Link is in. */
            spaceId?: string;
            status?: components["schemas"]["ContentStatus"];
        ...
        SpaceRole: {
            ...
            id?: string;
            /** @description The name for the space role. */
            name?: string;
         ...
         * @enum {string}
         */
        SpaceType: "global" | "collaboration" | "knowledge_base" | "personal" | "system" | "onboarding" | "xflow_sample_space";
        Task: {
        ...
        UpdateSpaceRoleResponse: {
            ...
            id?: string;
            /** @description Name of the space role */
            name?: string;
            /** @description Id of the task to update the space permissions associated with the space role */
            taskId?: string;
            type?: components["schemas"]["RoleType"];
...
export interface operations {
    ...
    getForgeAppProperties: {
        ...
        requestBody?: never;
        responses: {
            /** @description Forge app properties returned on success. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getForgeAppProperty: {
        ...
        requestBody?: never;
        responses: {
            /** @description App property returned on success. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description App property not found. */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getSpaceRoleMode: {
        ...
        requestBody?: never;
        responses: {
            /** @description Returned if the requested space role mode is returned. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": {
                        /**
                         * @description The space role mode.
                         * @enum {string}
                         */
            ...
            /** @description Returned if the calling user does not have permission to view the space role mode. */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createSpaceRole: {
        ...
        responses: {
            /** @description Returned if the requested space role is created. */
            201: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Returned if the calling user does not have permission to create space roles. */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    updateSpaceRole: {
        ...
        requestBody: {
            content: {
                "application/json": {
                    /** @description If space anonymous access is assigned to the role being modified, the Id of a role to migrate those assignments to can be specified. Anonymous access role assignments left unchanged if unspecified. */
                    anonymousReassignmentRoleId?: string;
                    /** @description Description for the space role */
                    description: string;
                    /** @description If guests are assigned to the role being modified, the Id of a role to migrate those assignments to can be specified. Guest role assignments left unchanged if unspecified. */
        ...
        responses: {
            /** @description Returned if the update of the space role was accepted. */
            202: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["UpdateSpaceRoleResponse"];
                };
            };
            /** @description Returned if an invalid request is provided. */
            400: {
            ...
            /** @description Returned if the calling user does not have permission to update space roles. */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    deleteSpaceRole: {
        ...
        requestBody?: never;
        responses: {
            /** @description Returned if the deletion of the space role was accepted. */
            202: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["DeleteSpaceRoleResponse"];
                };
            };
            /** @description Returned if an invalid request is provided. */
            400: {
            ...
            /** @description Returned if the calling user does not have permission to delete space roles. */
            404: {
                headers: {
                    [name: string]: unknown;
                };
